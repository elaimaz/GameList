...
namespace GameList.Data
{
    public class GamesController : Controller
    {
        ...
        public GamesController(GameListContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Genre,Plataform,Developer,Publisher,ReleaseDate,Description,Image")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Genre,Plataform,Developer,Publisher,ReleaseDate,Description,Image")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
